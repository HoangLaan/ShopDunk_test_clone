module.exports = {
  ...
  AUTH: {
    ...
    LOGIN: {
      ...
      BIOMETRIC_FAILED: 'Không thể xác minh. Vui lòng đăng nhập bằng username/password',
    },
    LOGOUT: {
  ...
  USER: {
    ...
    RESET_PASSWORD_SUCCESS: 'Update password success.',
    GENERATE_USERNAME_SUCCESS: 'Generate username success.',
    OLD_PASSWORD_WRONG: 'Mật khẩu cũ không chính xác.',
  },

  ERROR: {
    CREATE_SUCCESS: 'Create error success.',
    CREATE_FAILED: 'Create error failed.',
    UPDATE_SUCCESS: 'Update error success.',
    UPDATE_FAILED: 'Update error failed.',
    DELETE_SUCCESS: 'Delete error success.',
  },
  USER_GROUP: {
  ...
  CUSTOMERS: {
    CREATE_SUCCESS: 'Thêm mới khách hàng thành công.',
    CREATE_FAILED: 'Thêm mới khách hàng thất bại.',
    ...
    CREATE_CONTACT_SUCCESS: 'Thêm mới người liên hệ thành công.',
    CREATE_CONTACT_FAILED: 'Thêm mới người liên hệ thất bại.',
  },
  PRICE_QUOTE: {
  ...
  ORDERS: {
    ...
    CREATE_CUSTOMERDELIVERY_SUCCESS: 'Thêm mới xe khách hàng thành công.',
    CREATE_CUSTOMERDELIVERY_FAILED: 'Thêm mới xe khách hàng thất bại.',
    CREATE_PARTNER_TRANSPORT_SUCCESS: 'Thêm mới đơn vị vận chuyển thành công.',
    CREATE_PARTNER_TRANSPORT_FAILED: 'Thêm mới đơn vị vận chuyển thất bại.',
    UPDATE_STOCKS_SUCCESS: 'Xuất hàng thành công.',
    UPDATE_STOCKS_FAILED: 'Xuất hàng thất bại.',
  },

  DEBIT: {
    AMOUNT_ORDER_EXCEED_DEBIT: 'Số tiền thu nợ trên đơn hàng vượt quá số tiền nợ còn lại của đơn hàng.',
    ORDER_PAID: 'Đơn hàng đã được thanh toán hết nợ.',
    ORDER_NOT_FOUND: 'Mã đơn hàng truyền vào không hợp lệ.',
    PAY_FAILED: 'Thu nợ đơn hàng không thành công.',
    PAY_SUCCESS: 'Thu nợ thành công.'
  },
  STOCKSOUTREQUEST: {
  ...
  CUSTOMER: {
    ...
    UPDATE_SUCCESS: 'Update customer success.',
    UPDATE_FAILED: 'Update customer failed.',
    DELETE_SUCCESS: 'Delete customer success.',
    CHANGE_STATUS_SUCCESS: 'Change status customer success.',
  },
  REQUEST: {
