...
const envVarsSchema = Joi.object({
    ...
    CHAT_HASH_SECRET_KEY: Joi.string().required(),
...
const config = {
    appName: 'API',
    service_apikey: envVars.SERVICE_APIKEY,
    domain_service: envVars.DOMAIN_SERVICE,
    ...
    chatHashSecretKey: envVars.CHAT_HASH_SECRET_KEY,
    token: {
        key: 'Authorization',
        type: 'Bearer',
    },
