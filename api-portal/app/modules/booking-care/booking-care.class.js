...
const template = {
    ...
    expected_start_time_to: '{{#? EXPECTEDSTARTTIMETO }}',
...
const getListCareService = (data = {}) => {
    return transform.transform(data, ['care_service_id', 'care_service_name']);
};

const GroupServices = (areas = []) => {
    return transform.transform(areas, ['care_service_id', 'care_service_name', 'language_id', 'care_service_code']);
};
