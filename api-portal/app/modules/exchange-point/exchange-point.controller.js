...
const service = require('./exchange-point.service');
 ...
 * @returns {Promise<*>}
 */
const getListExchangePoint = async (req, res, next) => {
    try {
 ...
 * @returns {Promise<*>}
 */
const createExchangePoint = async (req, res, next) => {
    try {
...
const updateExchangePoint = async (req, res, next) => {
    try {
        // Check  exists
...
const deleteExchangePoint = async (req, res, next) => {
    try {
        // Delete
...
const detailExchangePoint = async (req, res, next) => {
    try {
