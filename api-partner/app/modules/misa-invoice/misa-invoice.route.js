...
// Xem hóa đơn nháp
routes.route('/view-demo').post(validate(rules.viewDemo), controller.viewDemo);

// xem phiếu xuất kho nháp
routes.route('/view-demo-transport').post(validate(rules.viewDemoTransport), controller.viewDemoStocksOut);

// xuất phiếu xuất kho
routes
    .route('/publish-transport-hsm/:stocks_out_request_id')
    .post(validate(rules.publishTransportHSM), controller.publishTransportHSM);
