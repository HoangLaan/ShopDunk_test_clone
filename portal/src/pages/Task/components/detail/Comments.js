...
import { createCareComment, getCareCommentList, getProductOptions } from 'services/task.service';
...
function Comments({ setLoading, taskDetailId, dataLeadsId, memberId, currWFlow, loadData }) {
  ...
  return (
    <React.Fragment>
      <BWAccordion
        title='Comments'
        componentCustom={<CommentList items={items} page={page} totalPages={totalPages} setParams={setParams} totalItems={totalItems} params={params} itemsPerPage={itemsPerPage}/>}>
