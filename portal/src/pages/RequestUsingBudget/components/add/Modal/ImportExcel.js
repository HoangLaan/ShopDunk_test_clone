...
// Service
import { downloadTemplate, importExcel } from 'services/request-using-budget.service';
  ...
  const handleDownloadTemplate = async () => {
    try {
      await downloadTemplate().then((response) => {
        ...
        link.setAttribute('download', `MauFileImportDeNghiSuDungNganSach_${configDate}.xlsx`);
