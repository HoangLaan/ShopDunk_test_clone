...
function ConfirmReconcile({ onClose }) {
  ...
  return (
    <div className='bw_modal bw_modal_open' id='bw_add_customer'>
      <div className='bw_modal_container bw_w600'>
        ...
        <div>
          <p style={{ textAlign: 'center', fontSize: '1.1rem' }}>Thực hiện đối trừ thành công !</p>
        </div>

        <div className='bw_footer_modal bw_mt_1' style={{ justifyContent: 'right' }}>
          <button type='button' className='bw_btn_success' onClick={onClose}>
            OK
          </button>
        </div>
      </div>
