...
export const deleteItem = (params) => {
  return httpClient.delete(route + `/delete-orders`, { params });
};
...
export const getListStoreBySale = (params = {}) => {
  return httpClient.get(route + `/store/sale`, { params });
};
...
export const getListMaterial = (params = {}) => {
  return httpClient.get(route + '/material', { params });
};
...
export const getOrderTypeById = (id) => {
  return httpClient.get(`/order-type/${id}`);
};

export const ExportExcelOrder = (params) => {
  const header = {
    responseType: `blob`,
  };
  return httpClient.get(route + `/export-excel-order`, { params, ...header }); 
};

export const updateInvoiceLink = (id, body) => {
  return httpClient.post(route + `/invoice-link/${id}`, body); 
};

export const getUserReviewOptions = (params = {}) => {
  return httpClient.get(route + `/user-review-options`, { params });
};

// tao don duyet
export const createOderReview = (params) => {
  return httpClient.put(route + `/create-order-review`, { params });
};

// tao don duyet
export const getListImageOrderReview = (params) => {
  return httpClient.get(route + `/list-images-order-review`,{ params } );
};
