...
const CustomerAddModal = ({ onClose, getOptsCustomer, setValueCustomer }) => {
  ...
  const onSubmit = async (payload) => {
    try {
      ...
      payload.is_system = 0;
      setLoading(true);
      const memberDetail = await createCustomer({...payload, phone_number: payload?.phone_number?.trim(), fullNameCustomer: payload?.full_name});
            ...
            <div className='bw_main_modal'>
              <div className='bw_row'>
                <div className='bw_col_4'>
                  ...
                  <FormItem label='Số điện thoại' style='gray'>
                    <FormInput
                      type='text'
                      field='phone_number'
