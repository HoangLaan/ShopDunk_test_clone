...
const route = '/menu-website';

export const getListReview = (params = {}) => {
  return httpClient.get(route, { params });
};
export const generateNextCode = () => {
  return httpClient.get('/menu-website/generate-next-code');
};
export const getReview = (params) => {
  return httpClient.get(route, { params });
};
export const updateChangeStatus = (id, params) => {
  return httpClient.put(`/menu-website${id}/change-status`, params);
};
...
//   return httpClient.put(route + `/${id}`);
// };
...
export const deleteItem = (id) => {
  return httpClient.delete('/menu-website/delete', { id });
};
