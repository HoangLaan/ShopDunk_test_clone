...
import StocksOutRequestDetail from './components/add/StocksOutRequestDetail';
import StocksOutRequestInformation from './components/add/StocksOutRequestInformation';
import StocksOutRequestProduct from './components/add/StocksOutRequestProduct';
import StocksOutRequestReview from './components/add/StocksOutRequestReview';
...
const StocksOutRequestAddPage = ({ isModel, productList }) => {
