...
const TimeRangeOpttions = [
  ...
  {
    label: 'Hôm nay',
    value: TIME_RANGE.TODAY,
    start_date: moment().format(DATE_FORMAT),
    end_date: moment().format(DATE_FORMAT),
  },
  {
    label: 'Tuần này',
    value: TIME_RANGE.CURRENT_WEEK,
...
const DefaultParams = {
  itemsPerPage: 25,
  page: 1,
  start_date: TimeRangeOpttions.find((_) => _.value === TIME_RANGE.CURRENT_YEAR).start_date,
  end_date: TimeRangeOpttions.find((_) => _.value === TIME_RANGE.CURRENT_YEAR).end_date,
};
