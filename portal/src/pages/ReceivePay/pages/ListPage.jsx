...
import { getList, exportExcel } from 'services/receive-pay.service';
  ...
  const handleExportExcel = () => {
    ...
    exportExcel(params)
      .then((response) => {
        ...
        link.setAttribute('download', `ds_cong_no_phai_tra_${createdDate}.xlsx`);
