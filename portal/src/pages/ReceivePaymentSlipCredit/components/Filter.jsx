...
const ReceiveSlipFilter = ({ onChange, storeOpts }) => {
  ...
  const getOptionsData = useCallback(() => {
    ...
    dispatch(getOptionsGlobal('bankAcc'));
  }, []);
        ...
        actions={[
          {
            ...
            component: (
              <FormInput
                field='search'
                placeholder='Nhập số chứng từ, tên đối tượng, cửa hàng, số tài khoản ngân hàng'
              />
            ),
          },
          {
          ...
          {
            title: 'Số tài khoản',
            component: <FormSelect field='bank_acc_number' list={mapDataOptions4SelectCustom(bankAccData)} />,
          },
          {
