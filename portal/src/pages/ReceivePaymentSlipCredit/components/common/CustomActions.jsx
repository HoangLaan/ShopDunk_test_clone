  ...
  const items = [
    {
      ...
      label: (
        <BlankButton
          onClick={() => window._$g.rdr(`/receive-payment-slip-credit/add?type=1`)}
          icon='fi fi-rr-plus'
          title='Thêm ủy nhiệm thu'
        />
      ),
    },
    {
      ...
      label: (
        <BlankButton
          onClick={() => window._$g.rdr(`/receive-payment-slip-credit/add?type=2`)}
          icon='fi fi-rr-plus'
          title='Thêm ủy nhiệm chi'
        />
      ),
    },
  ];
