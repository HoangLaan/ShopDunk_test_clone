    ...
    return [
      {
        ...
        onClick: () => window._$g.rdr(`/purchase-orders/add`),
      },
      {
        icon: 'fi fi-rr-add',
        color: 'blue',
        ...
        hidden: (_) => _.order_status === STATUS_PURCHASE_ORDERS.IMPORTED,
        onClick: (_) => {
          history.push(`/stocks-in-request/add?tab_active=stocks_in_request&purchase_order_id=${_.purchase_order_id}`, {
            purchase_order_code: _.purchase_order_code,
          });
        },
      },
      {
