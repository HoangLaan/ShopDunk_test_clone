...
import { MinInventorySchema } from 'pages/Material/helpers/constructors';
  ...
  const columns = useMemo(
    () => [
      ...
      },
      {
        ...
        formatter: (value, key) => (
          <FormSelect
            ...
            list={mapDataOptions4Select(watch(`min_inventory_list[${key}].stock_type_options`))}
            validation={{
      ...
      },
      {
        ...
        styleHeader: { maxWidth: '130px', textWrap: 'wrap' },
        classNameHeader: 'bw_text_center',
        classNameBody: 'bw_text_center',
        formatter: (value, key) => (
