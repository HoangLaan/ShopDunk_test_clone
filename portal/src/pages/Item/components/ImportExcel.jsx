...
// Service
import { downloadTemplate, importExcel } from 'services/item.service';
  ...
  const handleDownloadTemplate = async () => {
    try {
      await downloadTemplate().then((response) => {
        ...
        link.setAttribute('download', `MauFileImportKhoanMuc_${configDate}.xlsx`);
        ...
        <div className='bw_main_modal'>
          ...
          <div className='bw_note'>
            ...
            <p>
              ...
              (file excel danh sách khoản mục mẫu)
            </p>
          </div>
