...
// Service
import { downloadTemplate, importExcel } from 'services/accounting-account.service';
  ...
  const handleDownloadTemplate = async () => {
    try {
      await downloadTemplate().then((response) => {
        ...
        link.setAttribute('download', `Mau_Tai_Khoan_${configDate}.xlsx`);
        ...
        <div className='bw_main_modal'>
          ...
          <div className='bw_note'>
            ...
            <p>
              ...
              (file excel danh sách tài khoản kế toán mẫu)
            </p>
          </div>
