...
export default function ImportModal({ onClose, importService }) {
  ...
  //       link.setAttribute('download', `MauFileImportSanPham_${configDate}.xlsx`);
        ...
        <div className='bw_main_modal'>
          ...
          <div className='bw_note'>
            ...
            {/* <p>
              ...
              (file excel danh sách túi bao bì mẫu)
            </p> */}
          </div>
          {uploading ? (
            <div className='bw_import_file'>Đang tải lên ...</div>
          ) : (
            <div className='bw_import_file' {...getRootProps()}>
              <section>
                <div>
                  <input {...getInputProps()} />
