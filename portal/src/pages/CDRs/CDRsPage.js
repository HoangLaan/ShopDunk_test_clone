...
import { getListCdrs, exportExcel } from 'services/voip.services';
import { DEFAULT_STATUS_CALL, IS_MISSED_CALL } from './utils/constants';
  ...
  const handleExportExcel = () => {
    ...
    exportExcel(params)
      .then((response) => {
        ...
        link.setAttribute('download', `VOID_SHOPDUNK_${createdDate}.xlsx`);
