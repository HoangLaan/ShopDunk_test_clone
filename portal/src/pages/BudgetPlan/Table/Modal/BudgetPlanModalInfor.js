...
function BudgetPlanModalInfor({ disabled, title, dataDetail }) {
    ...
    const getOptionBudget = async () => {
        let value = await getOptionsTreeView({
            budget_plan_id: dataDetail.budget_plan_id
        })
        return value
    }
        ...
        <BWAccordion title={title}>
            <div className='bw_row'>
                <div className='bw_col_12'>
                    <FormItem className='bw_col_12' label='Công ty' isRequired disabled={true}>
                        <FormSelect
                            field='company_id'
                            list={companyOpts}
                            validation={{
                ...
                <div className='bw_col_12'>
                    <FormItem label='Tên kế hoạch ngân sách' isRequired={true} disabled={true} className='bw_col_12'>
                        <FormInput
                ...
                <div className='bw_col_12'>
                    <FormItem label='Phòng ban duyệt' className='bw_col_12' isRequired={true} disabled={true}>
                ...
                <div className='bw_col_6'>
                    <FormItem label='Từ tháng' className='bw_col_12' isRequired={true} disabled={true}>
                        <FormDatePicker
                ...
                <div className='bw_col_6'>
                    <FormItem label='Đến tháng' className='bw_col_12' isRequired={true} disabled={true} >
                        <FormDatePicker
...
export default BudgetPlanModalInfor;
