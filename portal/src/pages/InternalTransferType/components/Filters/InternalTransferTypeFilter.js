...
const InternalTransferTypeFilter = ({ onChange, onClearParams }) => {
    ...
    <FormProvider {...methods}>
      <FilterSearchBar
        ...
        actions={[
          {
            title: 'Từ khóa',
            component: <FormInput field='search' placeholder='Nhập tên hình thức chuyển tiền' />,
          },
          {
            title: 'Ngày tạo',
            component: (
...
export default InternalTransferTypeFilter;
