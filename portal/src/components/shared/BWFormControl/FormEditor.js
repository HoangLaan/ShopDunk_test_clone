...
const FormEditor = ({ field, validation, placeholder, className, disabled = false, height = 500 }) => {
  ...
  return (
    <React.Fragment>
      <Editor
        className={className}
        apiKey={'s51luwk0wbcqa0wjtve64tc4upw3akgfwdlwgb098kwubeyp'}
        ...
        init={{
          ...
          toolbar1:
            'undo redo | fullscreen | formatselect | bold italic backcolor styles| \n' +
            'alignleft aligncenter alignright alignjustify',
          toolbar2: 'bullist numlist outdent indent emoticons | removeformat | help | image',
